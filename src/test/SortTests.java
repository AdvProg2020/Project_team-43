...
public class SortTests {
    ...
    public void setAll() {
        ...
        category = new Category("laptop", null);
        seller = new Seller("seller", null, "asus");
        product1 = new Product("a", company, 1, category, seller);
        product2 = new Product("b", company, 2, category, seller);
        product3 = new Product("c", company, 3, category, seller);
        product4 = new Product("d", company, 4, category, seller);
        product5 = new Product("e", company, 5, category, seller);
